...
// Static profile data - no API rate limits
const PROFILE = {
...
// Static repos data - no API rate limits
const REPOS = [
  {
    name: 'WebScraper',
              ...
              <div class="social-links">
                ...
                ${
                  PROFILE.twitter_username
                    ? `<a href="https://twitter.com/${PROFILE.twitter_username}" target="_blank" class="social-button">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="section-container fade-in">
          ...
          <div class="contact-content">
            ...
            <div class="contact-buttons">
              ...
              ${
                PROFILE.email
                  ? `<a href="mailto:${PROFILE.email}" class="cta-button secondary-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
