(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const w="/assets/logo-XYpuJ04E.svg";(function(e){var t={};function s(i){if(t[i])return t[i].exports;var n=t[i]={i,l:!1,exports:{}};return e[i].call(n.exports,n,n.exports,s),n.l=!0,n.exports}s.m=e,s.c=t,s.d=function(i,n,a){s.o(i,n)||Object.defineProperty(i,n,{enumerable:!0,get:a})},s.r=function(i){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(i,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(i,"__esModule",{value:!0})},s.t=function(i,n){if(1&n&&(i=s(i)),8&n||4&n&&typeof i=="object"&&i&&i.__esModule)return i;var a=Object.create(null);if(s.r(a),Object.defineProperty(a,"default",{enumerable:!0,value:i}),2&n&&typeof i!="string")for(var c in i)s.d(a,c,(function(h){return i[h]}).bind(null,c));return a},s.n=function(i){var n=i&&i.__esModule?function(){return i.default}:function(){return i};return s.d(n,"a",n),n},s.o=function(i,n){return Object.prototype.hasOwnProperty.call(i,n)},s.p="",s(s.s=0)})([function(e,t){function s(d){return(s=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l})(d)}function i(d,l){for(var r=0;r<l.length;r++){var v=l[r];v.enumerable=v.enumerable||!1,v.configurable=!0,"value"in v&&(v.writable=!0),Object.defineProperty(d,v.key,v)}}function n(d,l){return!l||s(l)!=="object"&&typeof l!="function"?function(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}(d):l}function a(d){var l=typeof Map=="function"?new Map:void 0;return(a=function(r){if(r===null||(v=r,Function.toString.call(v).indexOf("[native code]")===-1))return r;var v;if(typeof r!="function")throw new TypeError("Super expression must either be null or a function");if(l!==void 0){if(l.has(r))return l.get(r);l.set(r,m)}function m(){return c(r,arguments,o(this).constructor)}return m.prototype=Object.create(r.prototype,{constructor:{value:m,enumerable:!1,writable:!0,configurable:!0}}),f(m,r)})(d)}function c(d,l,r){return(c=h()?Reflect.construct:function(v,m,k){var g=[null];g.push.apply(g,m);var p=new(Function.bind.apply(v,g));return k&&f(p,k.prototype),p}).apply(null,arguments)}function h(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch{return!1}}function f(d,l){return(f=Object.setPrototypeOf||function(r,v){return r.__proto__=v,r})(d,l)}function o(d){return(o=Object.setPrototypeOf?Object.getPrototypeOf:function(l){return l.__proto__||Object.getPrototypeOf(l)})(d)}var b=document.createElement("template");b.innerHTML=`
`.concat(`
<style>
:root {
  --fontSize: 14px;
...
`);var y=function(d){(function(p,u){if(typeof u!="function"&&u!==null)throw new TypeError("Super expression must either be null or a function");p.prototype=Object.create(u&&u.prototype,{constructor:{value:p,writable:!0,configurable:!0}}),u&&f(p,u)})(g,d);var l,r,v,m,k=(l=g,r=h(),function(){var p,u=o(l);if(r){var S=o(this).constructor;p=Reflect.construct(u,arguments,S)}else p=u.apply(this,arguments);return n(this,p)});function g(){return function(p,u){if(!(p instanceof u))throw new TypeError("Cannot call a class as a function")}(this,g),k.call(this)}return v=g,(m=[{key:"connectedCallback",value:function(){var p=this.attachShadow({mode:"open"});p.appendChild(b.content.cloneNode(!0)),this.getAttribute("year")===null?p.getElementById("year").innerHTML=new Date().getFullYear():p.getElementById("year").innerHTML=this.getAttribute("year")}}])&&i(v.prototype,m),g}(a(HTMLElement));window.customElements.define("copyright-x",y)}]);async function L(){return await(await fetch("https://api.github.com/users/hybridx")).json()}async function P(){return await(await fetch("https://api.github.com/users/hybridx/repos?sort=updated&per_page=6&fork=false")).json()}function E(){const e=document.documentElement,s=(e.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";e.setAttribute("data-theme",s),localStorage.setItem("theme",s),x(s)}function x(e){const t=document.getElementById("theme-toggle");t&&(t.innerHTML="",e==="dark"?t.innerHTML=`
    ...
    `)}function M(){const s=localStorage.getItem("theme")||"dark";document.documentElement.setAttribute("data-theme",s),x(s)}function C(){const e=document.querySelectorAll(".fade-in"),t=new IntersectionObserver(s=>{s.forEach(i=>{i.isIntersecting&&i.target.classList.add("visible")})},{threshold:.1});e.forEach(s=>{t.observe(s)})}function I(){const e=["Platform Engineer","Infrastructure Builder","Systems Thinker","DevConf India Organizer"],t=document.querySelector(".typing-text");if(!t)return;let s=0,i=0,n=!1,a=100;function c(){const h=e[s];n?(t&&(t.textContent=h.substring(0,i-1)),i--,a=50):(t&&(t.textContent=h.substring(0,i+1)),i++,a=100),!n&&i===h.length?setTimeout(()=>n=!0,2e3):n&&i===0&&(n=!1,s=(s+1)%e.length),setTimeout(c,a)}c()}function z(){const e=document.createElement("canvas");e.id="particle-canvas",e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.pointerEvents="none",e.style.zIndex="1",document.body.insertBefore(e,document.body.firstChild);const t=e.getContext("2d");let s=[];function i(){e.width=window.innerWidth,e.height=window.innerHeight}function n(){return{x:Math.random()*e.width,y:Math.random()*e.height,vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,size:Math.random()*2+1,opacity:Math.random()*.5+.1}}function a(){s=[];for(let o=0;o<50;o++)s.push(n())}function c(){s.forEach(o=>{o.x+=o.vx,o.y+=o.vy,(o.x<0||o.x>e.width)&&(o.vx*=-1),(o.y<0||o.y>e.height)&&(o.vy*=-1)})}function h(){t&&(t.clearRect(0,0,e.width,e.height),s.forEach(o=>{t&&(t.beginPath(),t.arc(o.x,o.y,o.size,0,Math.PI*2),t.fillStyle=`rgba(100, 108, 255, ${o.opacity})`,t.fill())}),s.forEach((o,b)=>{s.slice(b+1).forEach(y=>{if(!t)return;const d=Math.sqrt(Math.pow(o.x-y.x,2)+Math.pow(o.y-y.y,2));d<100&&(t.beginPath(),t.moveTo(o.x,o.y),t.lineTo(y.x,y.y),t.strokeStyle=`rgba(100, 108, 255, ${.1*(1-d/100)})`,t.lineWidth=1,t.stroke())})}))}function f(){c(),h(),requestAnimationFrame(f)}i(),a(),f(),window.addEventListener("resize",()=>{i(),a()})}function T(){const e=document.querySelectorAll(".skill-item"),t=new IntersectionObserver(s=>{s.forEach(i=>{if(i.isIntersecting){const n=i.target.querySelector(".skill-progress");if(n){const a=n.getAttribute("data-progress");a&&setTimeout(()=>{n.style.width=a+"%"},200)}}})},{threshold:.5});e.forEach(s=>{t.observe(s)})}function B(){const e=document.querySelectorAll(".timeline-item"),t=new IntersectionObserver(s=>{s.forEach(i=>{i.isIntersecting&&i.target.classList.add("visible")})},{threshold:.3});e.forEach(s=>{t.observe(s)})}function A(){const e=document.getElementById("loading-screen"),t=document.querySelector(".portfolio"),s=["Loading amazing content...","Fetching GitHub data...","Initializing animations...","Almost ready...","Welcome!"];let i=0;const n=document.querySelector(".loading-message"),a=setInterval(()=>{i<s.length-1&&(i++,n&&(n.textContent=s[i]))},800);setTimeout(()=>{clearInterval(a),e&&e.classList.add("hidden"),t&&t.classList.add("loaded"),setTimeout(()=>{e&&e.remove()},800)},3e3)}function j(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",s=>{var a;s.preventDefault();const i=t.getAttribute("href");if(!i)return;const n=document.querySelector(i);if(n){const c=((a=document.querySelector("header"))==null?void 0:a.offsetHeight)||80,h=n.getBoundingClientRect().top+window.scrollY-c;window.scrollTo({top:h,behavior:"smooth"})}})});const e=document.querySelector("header");if(e){let t=!1;const s=()=>{const i=window.scrollY,n=Math.min(.95,.7+i/300*.25);e.style.background=`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--header-bg").replace(/[^\d,]/g,"")}, ${n})`,t=!1};window.addEventListener("scroll",()=>{t||(requestAnimationFrame(s),t=!0)},{passive:!0})}}function D(){const e=document.querySelectorAll("img[data-src]"),t=new IntersectionObserver(n=>{n.forEach(a=>{if(a.isIntersecting){const c=a.target;c.src=c.dataset.src,c.classList.remove("lazy"),t.unobserve(c)}})});e.forEach(n=>{t.observe(n)});const s=document.createElement("link");s.rel="preload",s.as="font",s.crossOrigin="anonymous",document.head.appendChild(s);const i=document.createElement("link");i.rel="preconnect",i.href="https://api.github.com",document.head.appendChild(i)}function O(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.documentElement.style.setProperty("--animation-duration","0s"),document.documentElement.style.setProperty("--transition-duration","0s");const s=document.getElementById("particle-canvas");s&&(s.style.display="none")}document.addEventListener("keydown",s=>{s.key==="Tab"&&document.body.classList.add("keyboard-navigation")}),document.addEventListener("mousedown",()=>{document.body.classList.remove("keyboard-navigation")});const t=document.createElement("a");t.href="#hero",t.className="skip-link",t.textContent="Skip to main content",t.setAttribute("aria-label","Skip to main content"),document.body.insertBefore(t,document.body.firstChild)}function H(){window.addEventListener("error",e=>{console.error("Portfolio Error:",e.error);const t=document.getElementById("loading-screen");t&&t.classList.add("hidden");const s=document.querySelector(".portfolio");s&&s.classList.add("loaded")}),window.addEventListener("unhandledrejection",e=>{console.error("Unhandled Promise Rejection:",e.reason)})}function _(){window.addEventListener("load",()=>{setTimeout(()=>{const e=performance.getEntriesByType("navigation")[0];if(e){const t={dns:e.domainLookupEnd-e.domainLookupStart,tcp:e.connectEnd-e.connectStart,request:e.responseStart-e.requestStart,response:e.responseEnd-e.responseStart,domLoading:e.domContentLoadedEventEnd-e.fetchStart,domComplete:e.loadEventEnd-e.fetchStart};console.log("Performance Metrics:",t)}},0)})}async function V(){var n;const e=await L(),t=await P();M(),document.querySelector("#app").innerHTML=`
      ...
      <section id="projects">
        <div class="section-container fade-in">
          ...
          <div class="projects-grid">
            ${t.map((a,c)=>`
              <div class="project-card" data-index="${c}">
  ...
  `,(n=document.getElementById("theme-toggle"))==null||n.addEventListener("click",E);const s=document.querySelector(".cursor");document.addEventListener("mousemove",a=>{console.log(a.clientX,a.clientY),s&&(s.style.left=a.clientX+"px",s.style.top=a.clientY+"px")}),document.querySelectorAll("a, button").forEach(a=>{a.addEventListener("mouseenter",()=>{s&&s.classList.add("cursor-hover")}),a.addEventListener("mouseleave",()=>{s&&s.classList.remove("cursor-hover")})}),H(),D(),O(),_(),A(),j(),C(),I(),z(),T(),B()}V();
