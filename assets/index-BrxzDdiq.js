(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();const w="/assets/logo-XYpuJ04E.svg";(function(e){var s={};function t(i){if(s[i])return s[i].exports;var n=s[i]={i,l:!1,exports:{}};return e[i].call(n.exports,n,n.exports,t),n.l=!0,n.exports}t.m=e,t.c=s,t.d=function(i,n,a){t.o(i,n)||Object.defineProperty(i,n,{enumerable:!0,get:a})},t.r=function(i){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(i,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(i,"__esModule",{value:!0})},t.t=function(i,n){if(1&n&&(i=t(i)),8&n||4&n&&typeof i=="object"&&i&&i.__esModule)return i;var a=Object.create(null);if(t.r(a),Object.defineProperty(a,"default",{enumerable:!0,value:i}),2&n&&typeof i!="string")for(var c in i)t.d(a,c,(function(h){return i[h]}).bind(null,c));return a},t.n=function(i){var n=i&&i.__esModule?function(){return i.default}:function(){return i};return t.d(n,"a",n),n},t.o=function(i,n){return Object.prototype.hasOwnProperty.call(i,n)},t.p="",t(t.s=0)})([function(e,s){function t(d){return(t=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(r){return typeof r}:function(r){return r&&typeof Symbol=="function"&&r.constructor===Symbol&&r!==Symbol.prototype?"symbol":typeof r})(d)}function i(d,r){for(var l=0;l<r.length;l++){var v=r[l];v.enumerable=v.enumerable||!1,v.configurable=!0,"value"in v&&(v.writable=!0),Object.defineProperty(d,v.key,v)}}function n(d,r){return!r||t(r)!=="object"&&typeof r!="function"?function(l){if(l===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return l}(d):r}function a(d){var r=typeof Map=="function"?new Map:void 0;return(a=function(l){if(l===null||(v=l,Function.toString.call(v).indexOf("[native code]")===-1))return l;var v;if(typeof l!="function")throw new TypeError("Super expression must either be null or a function");if(r!==void 0){if(r.has(l))return r.get(l);r.set(l,m)}function m(){return c(l,arguments,o(this).constructor)}return m.prototype=Object.create(l.prototype,{constructor:{value:m,enumerable:!1,writable:!0,configurable:!0}}),f(m,l)})(d)}function c(d,r,l){return(c=h()?Reflect.construct:function(v,m,k){var g=[null];g.push.apply(g,m);var p=new(Function.bind.apply(v,g));return k&&f(p,k.prototype),p}).apply(null,arguments)}function h(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch{return!1}}function f(d,r){return(f=Object.setPrototypeOf||function(l,v){return l.__proto__=v,l})(d,r)}function o(d){return(o=Object.setPrototypeOf?Object.getPrototypeOf:function(r){return r.__proto__||Object.getPrototypeOf(r)})(d)}var b=document.createElement("template");b.innerHTML=`
`.concat(`
<style>
:root {
  --fontSize: 14px;
...
`);var y=function(d){(function(p,u){if(typeof u!="function"&&u!==null)throw new TypeError("Super expression must either be null or a function");p.prototype=Object.create(u&&u.prototype,{constructor:{value:p,writable:!0,configurable:!0}}),u&&f(p,u)})(g,d);var r,l,v,m,k=(r=g,l=h(),function(){var p,u=o(r);if(l){var S=o(this).constructor;p=Reflect.construct(u,arguments,S)}else p=u.apply(this,arguments);return n(this,p)});function g(){return function(p,u){if(!(p instanceof u))throw new TypeError("Cannot call a class as a function")}(this,g),k.call(this)}return v=g,(m=[{key:"connectedCallback",value:function(){var p=this.attachShadow({mode:"open"});p.appendChild(b.content.cloneNode(!0)),this.getAttribute("year")===null?p.getElementById("year").innerHTML=new Date().getFullYear():p.getElementById("year").innerHTML=this.getAttribute("year")}}])&&i(v.prototype,m),g}(a(HTMLElement));window.customElements.define("copyright-x",y)}]);async function L(){return await(await fetch("https://api.github.com/users/hybridx")).json()}async function P(){return await(await fetch("https://api.github.com/users/hybridx/repos?sort=updated&per_page=6&fork=false")).json()}function E(){const e=document.documentElement,t=(e.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";e.setAttribute("data-theme",t),localStorage.setItem("theme",t),x(t)}function x(e){const s=document.getElementById("theme-toggle");s&&(s.innerHTML="",e==="dark"?s.innerHTML=`
    ...
    `)}function M(){const t=localStorage.getItem("theme")||"dark";document.documentElement.setAttribute("data-theme",t),x(t)}function C(){const e=document.querySelectorAll(".fade-in"),s=new IntersectionObserver(t=>{t.forEach(i=>{i.isIntersecting&&i.target.classList.add("visible")})},{threshold:.1});e.forEach(t=>{s.observe(t)})}function I(){const e=["Platform Engineer","Infrastructure Builder","Systems Thinker","DevConf India Organizer"],s=document.querySelector(".typing-text");if(!s)return;let t=0,i=0,n=!1,a=100;function c(){const h=e[t];n?(s&&(s.textContent=h.substring(0,i-1)),i--,a=50):(s&&(s.textContent=h.substring(0,i+1)),i++,a=100),!n&&i===h.length?setTimeout(()=>n=!0,2e3):n&&i===0&&(n=!1,t=(t+1)%e.length),setTimeout(c,a)}c()}function z(){const e=document.createElement("canvas");e.id="particle-canvas",e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.pointerEvents="none",e.style.zIndex="1",document.body.insertBefore(e,document.body.firstChild);const s=e.getContext("2d");let t=[];function i(){e.width=window.innerWidth,e.height=window.innerHeight}function n(){return{x:Math.random()*e.width,y:Math.random()*e.height,vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,size:Math.random()*2+1,opacity:Math.random()*.5+.1}}function a(){t=[];for(let o=0;o<50;o++)t.push(n())}function c(){t.forEach(o=>{o.x+=o.vx,o.y+=o.vy,(o.x<0||o.x>e.width)&&(o.vx*=-1),(o.y<0||o.y>e.height)&&(o.vy*=-1)})}function h(){s&&(s.clearRect(0,0,e.width,e.height),t.forEach(o=>{s&&(s.beginPath(),s.arc(o.x,o.y,o.size,0,Math.PI*2),s.fillStyle=`rgba(100, 108, 255, ${o.opacity})`,s.fill())}),t.forEach((o,b)=>{t.slice(b+1).forEach(y=>{if(!s)return;const d=Math.sqrt(Math.pow(o.x-y.x,2)+Math.pow(o.y-y.y,2));d<100&&(s.beginPath(),s.moveTo(o.x,o.y),s.lineTo(y.x,y.y),s.strokeStyle=`rgba(100, 108, 255, ${.1*(1-d/100)})`,s.lineWidth=1,s.stroke())})}))}function f(){c(),h(),requestAnimationFrame(f)}i(),a(),f(),window.addEventListener("resize",()=>{i(),a()})}function T(){const e=document.querySelectorAll(".skill-item"),s=new IntersectionObserver(t=>{t.forEach(i=>{if(i.isIntersecting){const n=i.target.querySelector(".skill-progress");if(n){const a=n.getAttribute("data-progress");a&&setTimeout(()=>{n.style.width=a+"%"},200)}}})},{threshold:.5});e.forEach(t=>{s.observe(t)})}function B(){const e=document.querySelectorAll(".timeline-item"),s=new IntersectionObserver(t=>{t.forEach(i=>{i.isIntersecting&&i.target.classList.add("visible")})},{threshold:.3});e.forEach(t=>{s.observe(t)})}function A(){const e=document.getElementById("loading-screen"),s=document.querySelector(".portfolio"),t=["Loading amazing content...","Fetching GitHub data...","Initializing animations...","Almost ready...","Welcome!"];let i=0;const n=document.querySelector(".loading-message"),a=setInterval(()=>{i<t.length-1&&(i++,n&&(n.textContent=t[i]))},800);setTimeout(()=>{clearInterval(a),e&&e.classList.add("hidden"),s&&s.classList.add("loaded"),setTimeout(()=>{e&&e.remove()},800)},3e3)}function j(){document.querySelectorAll('a[href^="#"]').forEach(s=>{s.addEventListener("click",t=>{var a;t.preventDefault();const i=s.getAttribute("href");if(!i)return;const n=document.querySelector(i);if(n){const c=((a=document.querySelector("header"))==null?void 0:a.offsetHeight)||80,h=n.getBoundingClientRect().top+window.scrollY-c;window.scrollTo({top:h,behavior:"smooth"})}})});const e=document.querySelector("header");if(e){let s=!1;const t=()=>{const i=window.scrollY,n=Math.min(.95,.7+i/300*.25);e.style.background=`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--header-bg").replace(/[^\d,]/g,"")}, ${n})`,s=!1};window.addEventListener("scroll",()=>{s||(requestAnimationFrame(t),s=!0)},{passive:!0})}}function D(){const e=document.querySelectorAll("img[data-src]"),s=new IntersectionObserver(n=>{n.forEach(a=>{if(a.isIntersecting){const c=a.target;c.src=c.dataset.src,c.classList.remove("lazy"),s.unobserve(c)}})});e.forEach(n=>{s.observe(n)});const t=document.createElement("link");t.rel="preload",t.as="font",t.crossOrigin="anonymous",document.head.appendChild(t);const i=document.createElement("link");i.rel="preconnect",i.href="https://api.github.com",document.head.appendChild(i)}function O(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.documentElement.style.setProperty("--animation-duration","0s"),document.documentElement.style.setProperty("--transition-duration","0s");const t=document.getElementById("particle-canvas");t&&(t.style.display="none")}document.addEventListener("keydown",t=>{t.key==="Tab"&&document.body.classList.add("keyboard-navigation")}),document.addEventListener("mousedown",()=>{document.body.classList.remove("keyboard-navigation")});const s=document.createElement("a");s.href="#hero",s.className="skip-link",s.textContent="Skip to main content",s.setAttribute("aria-label","Skip to main content"),document.body.insertBefore(s,document.body.firstChild)}function H(){window.addEventListener("error",e=>{console.error("Portfolio Error:",e.error);const s=document.getElementById("loading-screen");s&&s.classList.add("hidden");const t=document.querySelector(".portfolio");t&&t.classList.add("loaded")}),window.addEventListener("unhandledrejection",e=>{console.error("Unhandled Promise Rejection:",e.reason)})}function _(){window.addEventListener("load",()=>{setTimeout(()=>{const e=performance.getEntriesByType("navigation")[0];if(e){const s={dns:e.domainLookupEnd-e.domainLookupStart,tcp:e.connectEnd-e.connectStart,request:e.responseStart-e.requestStart,response:e.responseEnd-e.responseStart,domLoading:e.domContentLoadedEventEnd-e.fetchStart,domComplete:e.loadEventEnd-e.fetchStart};console.log("Performance Metrics:",s)}},0)})}async function V(){var n;const e=await L(),s=await P();M(),document.querySelector("#app").innerHTML=`
